import { ApexAxisChartSeries, ApexChart, ApexDataLabels, ApexLegend, ApexPlotOptions, ApexResponsive, ApexTitleSubtitle, ApexXAxis, ApexYAxis, } from 'ng-apexcharts';
...
//Area Spaline Chart
export const areaSpalineChart : ChartOptions | any = {
    chart: {
        height: 350,
        type: 'area',
        toolbar: {
...
// Basic Bar Chart
export const basicBarChart : ChartOptions | any  = {
    chart: {
        height: 350,
        type: 'bar',
        toolbar: {
...
// Column Chart
export const columnChart : ChartOptions | any = {
    chart: {
        height: 350,
        type: 'bar',
        toolbar: {
...
export const stepLineChart : ChartOptions | any = {
    chart: {
        type: 'line',
        height: 350,
        toolbar: {
...
// Column Chart 2
export const columnChart2 : ChartOptions | any = {
    annotations: {
        yaxis: [{
            y: 8200,
            borderColor: '#00E396',
...
// Candlestick Chart
export const candlestickChart : ChartOptions | any = {
    chart: {
        height: 350,
        type: 'candlestick',
        toolbar: {
